...
class plgVmPaymentMoip extends vmPSPlugin {
	...
	public function Moip_mostraParcelamento($method, $order) {	
		...
		$conteudo = '
			...
			<div style="border: 1px solid #ff7764;">
	...
	public function getPagamentoBoleto() {
		...
		<div><h4 class="titulo_toggle">
			<input type="radio" name="toggle_pagamentos" id="toggle_boleto" value="boleto" onclick="efeito_divs(\'div_boleto\',\'div_cartao\',\'div_debito\')" />
	...
	public function getPagamentoCartao($method, $order) {
		...
		$html ='
			<div id="div_cartao">
			<div><h4 class="titulo_toggle">
				<input type="radio" name="toggle_pagamentos" value="cartao" id="toggle_cartao" onclick="efeito_divs(\'div_cartao\',\'div_boleto\',\'div_debito\')" />
	...
	public function getPagamentoDebito($method, $order) {
		...
		$html ='
			<div id="div_debito">
			<div><h4 class="titulo_toggle">
				<input type="radio" name="toggle_pagamentos" id="toggle_debito" value="debito" onclick="efeito_divs(\'div_debito\',\'div_boleto\',\'div_cartao\')" />
